...
public class BouncePopUpController extends GUIController implements Initializable {
    @FXML
    ...
    @FXML
    private BouncesController option;
    ...
    public void choice(BouncesController option) {
        this.option = option;
        // Set current values.
